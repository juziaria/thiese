...
public class BaiduUtil {
    ...
    public static Map<String, String> getCityByLonLat(String key, String lng, String lat) {
        ...
        try {
            ...
            JsonNode rootNode = oMapper.readTree(result);
            JsonNode addressComponent = rootNode.get("result").get("addressComponent");
            Map<String, String> area = new HashMap<>();
            area.put("province", addressComponent.get("province").asText());
            area.put("city", addressComponent.get("city").asText());
            area.put("district", addressComponent.get("district").asText());
            area.put("street", addressComponent.get("street").asText());
            return area;
        }catch (Exception e) {
            e.printStackTrace();
        }

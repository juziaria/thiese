...
@Slf4j
public class ImportListen implements ReadListener<Student> {
    /**
     ...
     */
    private final IStudentInfoService infoService;
     ...
     * @param infoService
     */
    public ImportListen(List<String> errorMessage,IStudentInfoService infoService) {
    ...
    private void saveData() {
        ...
        infoService.saveBatch(cachedDataList);
        log.info("存储数据库成功！");
    }
